...
class CVPage extends AbstractPage {
    ...
    private function getPersonalInformation() {
        return
            ...
            '							<tr> <td>' . $this->I18nMessages[GrigorievCommon::I18N_TRANSLATION_ID_DATE_OF_BIRTH]->{i18n_translations::VALUE} . ' :</td>		<td>' . I18n::localizedDate($this->person->{persons::DATE_OF_BIRTH}, $this->language) . '</td> </tr>' . PHP_EOL .
